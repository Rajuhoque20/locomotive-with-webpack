...
export const useSimulatorStore=create((set,get)=>({
    ...
    activeId:'/simulatorsimulator-home',
    cardData:[],
    tabs:[
        { id: '/simulatorsimulator-home', title: 'Home', type: 'home', content: {}, fixed: true,path:'/simulatorsimulator-home' }
    ],
...
//       if(callback){
//         const latestActiveTab = get().activeTab;
// console.log("Latest activeTab:", latestActiveTab);
//         callback(latestActiveTab)
//       }
    },
